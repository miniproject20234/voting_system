                                ...
                                <div className="ml-4 flex-shrink-0 flex items-center ">
                                    {userDetails ? (
                                        <div className="text-blue-600">
                                            <b><i>{userDetails.username}</i></b>
                                        </div>
                                    ) : (
                                        <div>
                                            <NavLink exact to="/auth">
                                                <button className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 shadow-sm hover:bg-blue-700">
                                                    Log in now!
                                                </button>
                                            </NavLink>
                                        </div>
                        ...
                        <div className="fixed  z-40  p-4 inset-x-0  top-20">
                            <div className="pt-2  pb-3 rounded-sm bg-white space-y-1">
                                <NavLink
                                    ...
                                    to="/"
                                    className={({ isActive }) =>
                                        `border-transparent text-gray-500 hover:bg-gray-200 hover:border-gray-500 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium sm:pl-5 sm:pr-6 ${isActive ? 'bg-blue-200 border-l-4 border-blue-500 text-blue-700  ' : ''
                                        }`
                                    }
                                >
                                    Home
                            ...
                            <div className="pt-4 pb-3 border-t bg-white border-gray-200 ">
                                <div className="flex items-center px-4 sm:px-6">
                                    ...
                                    <div className="ml-3">
                                    {userDetails && ( <div className="text-base font-medium text-gray-800"> <i>{userDetails.username}</i></div>)}
                                        <div className="text-base font-medium text-gray-800"><i>{email}</i></div>
                                ...
                                {userDetails && (<div >
                                    <NavLink
                                        ...
                                        to="/profile"
                                        className={({ isActive }) =>
                                            `border-transparent text-gray-500 mt-2 hover:bg-gray-200 hover:border-gray-500 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium sm:pl-5 sm:pr-6 ${isActive ? 'bg-blue-200 border border-l-4 border-blue-500 text-blue-700  ' : ''
                                            }`
                                        }
                                    >
                                        Your Profile
