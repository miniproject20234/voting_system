      ...
      <div className="flex justify-between items-center p-4 bg-gray-800 text-white">
        ...
        <AlertDialog.Root>
          <AlertDialog.Trigger asChild>
            <button
              className={`bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ${username === 'User Not logged' ? 'opacity-50 cursor-not-allowed' : ''}`}
              onClick={username === 'User Not logged' ? handleLogout : undefined}
              disabled={username === 'User Not logged'}
            >
              Log Out
            </button>
          </AlertDialog.Trigger>
